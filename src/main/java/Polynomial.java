...
public class Polynomial {
    ...
    public static Polynomial multiply() {
        ...
        for(int loop1=0;loop1<=greaterDegree;loop1++) {
            for(int loop2=0;loop2<=smallerDegree;loop2++) {
                objectForPolynomial3.coefficients[loop1+loop2] += objectForPolynomial3.coefficients[loop1+loop2]+objectForPolynomial1.coefficients[loop1] * objectForPolynomial2.coefficients[loop2];
            }
        }
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Testing addNode function");
        Polynomial obj = add();
